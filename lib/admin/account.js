...
export async function me(req, res) {
  ...
  json(res, 200, await sessionPayload(user));
}

/**
 * Was jede Admin-Seite nach der Anmeldung braucht. Auch die Telegram Mini App
 * bekommt genau das zurück, damit sie danach nicht noch einmal /session ruft.
 */
